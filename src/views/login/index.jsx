...
import { AlterFavIcon, Logo } from "../../../src/common/imagepath";
import { useForm, Controller } from "react-hook-form";
import { yupResolver } from "@hookform/resolvers/yup";
import { AuthContext } from "../../../src/approuter";
...
const Login = () => {
  ...
  useEffect(() => {
    if (!localStorage.getItem("userId")) setloggedin(false);
                    ...
                    <form onSubmit={handleSubmit(submitLoginForm)}>
                      ...
                      {/* <div className="d-flex justify-content-between">
                        <Link
                          ...
                          to="#"
                          onClick={() => {
                            setValue("email", "logeshktgt@gmail.com");
                            setValue("password", "abcdABD123@!");
                          }}
                        >
                          {" "}
                          Admin Login{" "}
                      ...
                      <button
                        className="btn btn-lg btn-block w-100 btn-primary w-100  mt-3 mb-3 me-1"
                        type="submit"
                      >
                        Login
                      </button>
