...
import { AlterFavIcon, PreviewImg, profileDemo } from "../../../common/imagepath";
...
const Header = memo((props) => {
  ...
  const userName = userDetail?.employeeName || "Demo"
  const roleName =userDetail?.roleName || "Admin"
  return (
    <>
      <Helmet>
          ...
          <li className="nav-item dropdown">
            ...
            >
              <span className="user-img">
                <img
                  src={profileData?.image ? profileData?.image : profileDemo}
                  onError={(event) => {
                    event.target.src = profileDemo;
                  }}
                  alt=""
